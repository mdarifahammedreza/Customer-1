...
<div className=" bg-gradient-to-b from-white to-gray-100 rounded-md shadow-md p-5">
      ...
      {[...Array(6)].map((_, index) => (
        ...
        className="flex justify-evenly items-center border-t  px-5 py-3 hover:bg-gray-200 hover:border-x hover:cursor-pointer transition-colors duration-200"
      >
        <p>Name</p>
        <p>Area</p>
        <p>Description</p>
    ...
    <section>
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        The environment where we work greatly influences productivity and creativity.
         Whether at home, in an office, or a co-working space, the setting shapes our 
         success.
        </p>
      </div>
      <WorldMap
