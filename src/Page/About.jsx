    ...
    <div className="text-base_900">
      ...
      <div className="w-full h-5 grid grid-cols-3 bg-black">
        ...
        <div className="px-72 mt-10  p-10">
          <p className="card-title font-sans font-bold text-base_600" >About CBSG</p>
        ...
        <div className="">
          <div className="card">
              <div className="card-body  pl-0 pt-0">
                  <h2 className="card-title font-sans font-bold text-base_600"><div className="flex items-center justify-center text-base_600"><p>Our Mission</p> </div></h2>
...
fostering learning to be more effective and efficient in accomplishing their goals.</p>
        ...
        <div className="card">
              <div className="card-body pt-0">
                  <h2 className="card-title font-sans font-bold text-base_600"><div className="flex items-center justify-center"><p>Our Vision</p> </div></h2>
      ...
      <div  className="w-full grid grid-cols-3 gap-5 px-72  justify-items-center p-10">
        <div className="card col-span-2 w-full">
              <div className="card-body pl-0 ">
                  <h2 className="card-title font-sans font-bold text-base_600"><div className="flex items-center justify-center"><p>Our Core Values</p> </div></h2>
