...
const Card = ({ title, description, photo, className }) => {
  return (
    <div
      className={cn(
        "row-span-1 rounded-xl group/bento shadow-xl transition duration-200 shadow-input dark:shadow-none p-4 bg-white   border border-gray-300 justify-between flex flex-col space-y-4 h-[18rem] max-w-[20rem]",
    ...
    >
      ...
      <div className="group-hover/bento:translate-x-2 transition duration-200">
        <div className="font-sans font-bold text-neutral-600  mb-2 mt-2 border-b border-gray-300">
          {title}
        </div>
